 ...
 * @LastEditTime: 2022-03-17 11:48:24
 */
// 请求参数处理接受口
...
class JsError{
  ...
  weChatRequest(data){
    ...
    wx.request({
      url: 'http://10.190.46.70/zebra-monitor/jserror', 
      data:data,
      success (res) {
  ...
  init(){
    try{
      ...
      // window.rejectionhandled = (e) => {
      //   console.log('rejection handled1212');
      // }
      // // 监听reject
      // window.addEventListener('rejectionhandled', event => {
      //   console.log('rejection handled1212'); // 1秒后打印"rejection handled"
      // });
    } catch(error){
      console.log(error)
    }
